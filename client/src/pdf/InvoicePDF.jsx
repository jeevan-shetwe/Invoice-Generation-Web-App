...
// //               <Image
// //                 src={getFullUrl(company?.logoUrl || branding?.logoUrl)}
// //                 style={styles.logo}
// //               />
// //             ) : (
...
// //               style={[
// //                 styles.bold,
// //                 { color: "#111827", fontSize: 11, marginBottom: 4 },
// //               ]}
// //             >
...
// //               <Text style={[styles.totalsText, { color: "#6b7280" }]}>
// //                 Subtotal
// //               </Text>
// //               <Text style={[styles.totalsText, styles.bold]}>
// //                 {symbol}
...
// //               <Text style={[styles.totalsText, styles.bold, { fontSize: 12 }]}>
// //                 Total Amount
// //               </Text>
// //               <Text style={[styles.totalsText, styles.bold, { fontSize: 14 }]}>
// //                 {symbol}
...
// //                 Repeats: {invoice.recurringIntervalValue}{" "}
// //                 {invoice.recurringInterval}(s)
// //               </Text>
// //               <Text style={{ fontSize: 8, color: "#4b5563", marginTop: 2 }}>
// //                 Next Date:{" "}
// //                 {invoice.nextRecurrenceDate &&
// //                 !isNaN(new Date(invoice.nextRecurrenceDate).getTime())
// //                   ? new Date(invoice.nextRecurrenceDate).toLocaleDateString()
// //                   : "Not scheduled"}
// //               </Text>
// //               <Text style={{ fontSize: 8, color: "#4b5563", marginTop: 2 }}>
// //                 Ends:{" "}
// //                 {invoice.recurringEndType === "Never"
// //                   ? "Never"
// //                   : invoice.recurringEndType === "Date"
// //                     ? `On ${invoice.recurringEndDate}`
...
// //                       style={[
// //                         styles.bold,
// //                         { fontSize: 8, width: 100, color: "#6b7280" },
// //                       ]}
// //                     >
// //                       {f.label}:
// //                     </Text>
...
// //               <Image
// //                 src={getFullUrl(invoice.signatureUrl)}
          ...
          <View style={{ width: 200 }}>
            ...
            {fields.showTax !== false && (
              <View style={styles.totalsRow}>
                ...
                <Text style={[styles.totalsText, styles.bold]}>
                  {symbol}
                  {parseFloat(invoice.taxTotal || 0).toFixed(2)}
                </Text>
              </View>
            )}
